...
To load completions in your current shell session:
	...
	source <(kubectl-kruise completion zsh)
...
#### macOS:
	...
	kubectl-kruise completion zsh > $(brew --prefix)/share/zsh/site-functions/_kubectl-kruise

You will need to start a new shell for this setup to take effect.


```
kubectl-kruise completion zsh [flags]
```
